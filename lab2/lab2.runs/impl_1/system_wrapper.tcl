...
set rc [catch {
  ...
  open_checkpoint D:/embedded/lab2/lab2.runs/impl_1/system_wrapper.dcp
  set_property webtalk.parent_dir D:/embedded/lab2/lab2.data/wt [current_project]
  set_property parent.project_dir D:/embedded/lab2 [current_project]
